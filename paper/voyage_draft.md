...
The River Fleet is the occasion that originates the journey; it is the space that permeates every angle and every word of the poem. It is the smell of the poem, it is its consistency. 

- List of the shit found in the Fleet;

- focus on the professions of the soap makers and the tanners; 

- focus on the production of a boundary.
...
- __Here we need to talk about the Fleet.__
	...
	- __Ben Jonson on the Fleet.__ What is known about the poem: there was a lot of shit here.

- The setting. What is the Fleet. Why it is a problem.

	- Two ideas at the basis of the notion of _ecosystem_: __cycle__ and __boundary__. They are both corrupt in the Fleet. The __cycle__ is fucked up, because the __boundary__ is not working as it should (and vice versa); the __input__ becomes the __output__.
...
The river is also the quintessential ecosystem; and the Fleet is no exception.
...
###Confusion and pollution: the fusion of boundaries
